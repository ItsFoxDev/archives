...
s.innerHTML='#archiveoverlay{inset:0px;opacity:1;transition:opacity .3s ease;display:flex;align-content:center;justify-content:center;flex-direction:column;flex-wrap:wrap;align-items:center;position:fixed;width:100vw;height:100vh;background:yellow;z-index:999;color:black;font-weight:bold;font-size:20px;}#archiveoverlay i{font-weight:bold !important;font-size:30px;}#archiveoverlay *{color:black;font-weight:normal;font-size:15px;}'
